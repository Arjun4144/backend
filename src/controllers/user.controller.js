...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // check if user alreadu exists: username. email
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    //To delete previous coverImage from cloudinary
    const user = await User.findById(req.user?._id);
    ...
    return res.status(200).json(new ApiResponse(200, updatedUser, "User coverImage updated successfully"))
});
